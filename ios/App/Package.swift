...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorFirebaseMessaging", path: "../../../node_modules/.pnpm/@capacitor-firebase+messaging@8.1.0_@capacitor+core@8.1.0/node_modules/@capacitor-firebase/messaging"),
